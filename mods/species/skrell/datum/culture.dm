/decl/cultural_info/culture/skrell
	...
	description = "Considered as the leaders of Skrellkind, the Qerr-Katish are the face and soul of skrellian society. \
		...
		that are long and flowing and have often been compared to the clothing of ancient Chinese nobles by human scholars. \
		Qerr-Katish headtails are famously long, reaching down to nearly their waists."
	economic_power = 1.4
...
/decl/cultural_info/culture/skrell/caste_kanin
	...
	description = "The main workforce of the Skrell. While their population growth has decreased over the millennia of technological \
		...
		through arm bands or headtail decorations of any kind. They have very short headtails."
	economic_power = 1.2
...
/decl/cultural_info/culture/skrell/caste_talum
	...
	description = "Considering the Skrells' emphasis on functionality and practicality, one would be mistaken to think they do not consider arts much. \
		...
		clothing that is colourful , adorned with embroidery and their headtails sparkling with various brilliant metals.  Talum-Katish headtails are a middle \
		ground between the shorter headtails of the Malish and the extremely long headtails of the Qerr, and are an important element of Talum self-expression."
	economic_power = 1.3
...
/decl/cultural_info/culture/skrell/caste_raskinta
	...
	description = "Rarely seen outside the skrellian society, the Raskinta-Katish are however recognised and respected by their entire species, for \
		...
		for while not working, however they tend to stick to clothing that is easy to move in and are often dark blue. Raskinta headtails are extremely \
		short, and this caste possesses four rather than three headtails, with the one in the back split into two. Uniquely among Raskinta, loss of a headtail \
		is not seen as disfiguring, especially if it was lost in battle."
	economic_power = 1.2

/decl/cultural_info/culture/skrell/casteless
	name = "Ue-Katish"
	description = "While not technically a ‘Caste’ by itself, the Ue-Katish make up only an incredibly small fraction of the total Skrellian population.\
		Born to unions of Skrell of two different castes or two Ue-Katish, the Ue-Katish typically have no place in the regimented society of the Skrell. \
		Many work in various forms of dangerous, unpleasant, and low-paying labor, and although they are still Skrell and individuals with rights, \
		discrimination still ends up being extremely common. Many Ue-Katish try to imitate other castes in an attempt to pass as a Kanin, a Malish or \
		another caste, or leave for a more tolerant life either inside human territory, nomadically, or as pirates. Ue-Katish are often not \
		discriminated against as much in the colonies that are closer to the human border as a result of ‘cultural bleed’, but they are still viewed with mistrust. \
		...
		This can greatly limit their ability to pass as another caste in society at times."
	economic_power = 0.8
	language = /decl/language/skrell/casteless
	secondary_langs = list(
